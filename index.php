    ...
    <section class="cd-section projects visible">
        ...
        <div class="cd-content" id="projects-content">
            ...
            <div align='center'>
                ...
                <map name="flowers">
                    <area shape="rect1" coords="280,38,386,215" class="real-show-hint" data-hint="#real-hint-1"
                          alt="room1" title="Комната 1" target="_self">

                    <area shape="rect2" coords="405,40,508,215" class="real-show-hint" data-hint="#real-hint-2"
                          alt="room2" title="Комната 2" target="_self">

                    <area shape="rect3" coords="527,40,626,215" class="real-show-hint" data-hint="#real-hint-3"
                          alt="room3" title="Комната 3" target="_self">

                    <area shape="rect4" coords="653,40,755,215" class="real-show-hint" data-hint="#real-hint-4"
                          alt="room4" title="Комната 4" target="_self">

                    <area shape="rect5" coords="777,40,881,215" class="real-show-hint" data-hint="#real-hint-5"
                          alt="room5" title="Комната 5" target="_self">

                    <area shape="rect6" coords="900,40,1010,215" class="real-show-hint" data-hint="#real-hint-6"
                          alt="room6" title="Комната 6" target="_self">

                    <area shape="rect7" coords="1025,40,1130,215" class="real-show-hint" data-hint="#real-hint-7"
                          alt="room7" title="Комната 7" target="_self">

                    <area shape="rect8" coords="124,306,260,483" class="real-show-hint" data-hint="#real-hint-8"
                          alt="room8" title="Комната 8" target="_self">

                    <area shape="rect9" coords="278,306,385,483" class="real-show-hint" data-hint="#real-hint-9"
                          alt="room9" title="Комната 9" target="_self">

                    <area shape="rect10" coords="402,306,509,483" class="real-show-hint" data-hint="#real-hint-10"
                          alt="room10" title="Комната 10" target="_self">

                    <area shape="rect11" coords="527,306,632,483" class="real-show-hint" data-hint="#real-hint-11"
                          alt="room11" title="Комната 11" target="_self">

                    <area shape="rect12" coords="652,306,766,483" class="real-show-hint" data-hint="#real-hint-12"
                          alt="room12" title="Комната 12" target="_self">

                    <area shape="rect13" coords="780,306,883,483" class="real-show-hint" data-hint="#real-hint-13"
                          alt="room13" title="Комната 13" target="_self">

                    <area shape="rect14" coords="901,306,1022,483" class="real-show-hint" data-hint="#real-hint-14"
                          alt="room14" title="Комната 14" target="_self">
